...
export const en: SwfEditorI18n = {
  ...
  nodes: {
    ...
    addConditionEdge: "Add Condition Transition",
    addDefaultEdge: "Add Default Transition",
    addCallTaskNode: "Add Call Task",
    addDoTaskNode: "Add Do Task",
    addEmitTaskNode: "Add Emit Task",
    addForTaskNode: "Add For Task",
    addForkTaskNode: "Add Fork Task",
    addListenTaskNode: "Add Listen Task",
    addRaiseTaskNode: "Add Raise Task",
    addRunTaskNode: "Add Run Task",
    addSetTaskNode: "Add Set Task",
    addSwitchTaskNode: "Add Switch Task",
    addTryTaskNode: "Add Try Task",
    addWaitTaskNode: "Add Wait Task",
