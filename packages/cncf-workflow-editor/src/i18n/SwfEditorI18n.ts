...
interface SwfEditorDictionary
  extends ReferenceDictionary<{
    ...
    nodes: {
      ...
      addConditionEdge: string;
      addDefaultEdge: string;
      addCallTaskNode: string;
      addDoTaskNode: string;
      addEmitTaskNode: string;
      addForTaskNode: string;
      addForkTaskNode: string;
      addListenTaskNode: string;
      addRaiseTaskNode: string;
      addRunTaskNode: string;
      addSetTaskNode: string;
      addSwitchTaskNode: string;
      addTryTaskNode: string;
      addWaitTaskNode: string;
      emptyDiagram: string;
